...
import type { CostGroup, CostSummary } from "@breadcrumb-sh/core/client";
import { fmtInt, fmtMoney } from "@breadcrumb-sh/core/kit";
import { useCost } from "../hooks.js";
...
export function CostView() {
  ...
  const cost = useCost({ days: Number(days), environment: env });
