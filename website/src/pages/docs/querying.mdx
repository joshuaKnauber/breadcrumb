...
Your traces live in your database, so the dashboard can look like your product. `bc.api` is the headless, typed query surface — call it from a Server Component, a route handler, or anywhere server-side. No HTTP, no client.
