...
Each snippet above mounts the API. The [dashboard](/docs/dashboard/) is a React
...
directly with [`bc.api`](/docs/querying/) and render it yourself, optionally
with the [headless kit](/docs/react/#headless-kit).
